    ...
    return Scaffold(
        body: SingleChildScrollView(
            child: SizedBox(
                ...
                child: Column(children: [
                  SizedBox(
                    ...
                    child: Padding(
                      ...
                      CustomText(inputText: "Order Details", color: Colors.black, fontWeight: FontWeight.bold, fontsize: 20),
                        Obx(() {
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  children: [
                                    Text(cartController.selectedColors[productId]
                                        .toString()),
                                    SizedBox(
                                      height: 10.h,
                                    ),
                                    Text(cartController.seledtedSize[productId]
                                        .toString()),
                                  ],
                                ),
                                SizedBox(
               ...
               Obx(
                ()=> CustomText(inputText: "Total: ${cartController.total.toString()}", color: Colors.black, fontWeight: FontWeight.bold, fontsize: 20,)),
               Container(
          width: 400.w,
